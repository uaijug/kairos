...
kairosApp.controller('MainController', function ($scope) {
    });
...
kairosApp.controller('LoginController', function ($scope, $location, AuthenticationSharedService) {
...
kairosApp.controller('LogoutController', function ($location, AuthenticationSharedService) {
        AuthenticationSharedService.logout();
    });

kairosApp.controller('SettingsController', function ($scope, Account) {
        $scope.success = null;
        $scope.error = null;
...
kairosApp.controller('RegisterController', function ($scope, $translate, Register) {
        $scope.success = null;
        $scope.error = null;
...
kairosApp.controller('ActivationController', function ($scope, $routeParams, Activate) {
...
kairosApp.controller('PasswordController', function ($scope, Password) {
        $scope.success = null;
        $scope.error = null;
        $scope.doNotMatch = null;
...
kairosApp.controller('SessionsController', function ($scope, resolvedSessions, Sessions) {
        $scope.success = null;
        $scope.error = null;
...
kairosApp.controller('LogsController', function ($scope, resolvedLogs, LogsService) {
...
kairosApp.controller('AuditsController', function ($scope, $translate, $filter, AuditsService) {
