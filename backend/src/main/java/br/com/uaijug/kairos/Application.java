...
public class Application {
	...
	public void initApplication() throws IOException {
		if (this.env.getActiveProfiles().length == 0) {
			...
			this.log.info("Running with Spring profile(s) : {}",
	 ...
	 *
	 * To run the application with hot reload enabled, add the following
	 * arguments to your JVM:
